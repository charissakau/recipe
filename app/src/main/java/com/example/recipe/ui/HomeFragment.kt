...
import com.example.recipe.data.MealsResponse
import com.example.recipe.data.RandomMealResponse
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainFragMVVM.observeMealByCategory()
            .observe(viewLifecycleOwner, object : Observer<MealsResponse> {
        ...
        mainFragMVVM.observeCategories()
            .observe(viewLifecycleOwner, object : Observer<CategoryResponse> {
        ...
        mainFragMVVM.observeRandomMeal()
            .observe(viewLifecycleOwner, object : Observer<RandomMealResponse> {
